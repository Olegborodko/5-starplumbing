...
add_filter(
	'pt-ocdi/replace_url',
	function () {
		return array( 'https://smartdata.tonytemplates.com/plumbio/' );
	}
);
...
add_filter(
	...
	function () {
		return '/wp-content/plugins/plumbio-demo-installer/images/';
	}
);
...
add_filter(
	...
	function () {
		return array(
			array(
				'import_file_name'             => esc_html__( 'Plumbio', 'chaoz' ),
				...
				'preview_url'                  => 'https://smartdata.tonytemplates.com/plumbio/',
				'local_import_redux'           => array(
					array(
						'file_path'   => plugin_dir_path( __FILE__ ) . 'demo-data/demo1/settings.json',
						'option_name' => 'plumbio_options',
					),
				),
			),
		);
